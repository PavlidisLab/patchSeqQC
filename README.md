...
```
## Downloading GitHub repo PavlidisLab/patchSeqQC@master
## from URL https://api.github.com/repos/PavlidisLab/patchSeqQC/zipball/master
```

```
## Installing patchSeqQC
```

```
## '/usr/lib64/R/bin/R' --no-site-file --no-environ --no-save --no-restore  \
##   --quiet CMD INSTALL  \
##   '/tmp/RtmpjHBaAN/devtools207fe2fba689/PavlidisLab-patchSeqQC-366562a'  \
##   --library='/home/stripathy/R/x86_64-redhat-linux-gnu-library/3.4'  \
##   --install-tests
```
